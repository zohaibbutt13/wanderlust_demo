...
if !Video.any?
  ...
  video1 = Video.create!(
             title: 'Teaser',
             description: 'A Teaser for your provided footage',
             cost_in_cents: 1500
           )
  ...
  video2 = Video.create!(
             title: 'Reel',
             description: 'A Reel for your provided footage',
             cost_in_cents: 2350
           )
  ...
  video3 = Video.create!(
             title: 'Highlights',
             description: 'A Highlights for your provided footage',
             cost_in_cents: 2000
           )
...
if !Project.any?
  ...
  project1 = client.projects.create!(
               title: 'Porject 1',
               footage_link: 'https://www.abc.com',
  ...
  project2 = client.projects.create!(
               title: 'Porject 2',
               footage_link: 'https://www.xyz.com',
  ...
  project3 = client.projects.create!(
               title: 'Porject 3',
               footage_link: 'https://www.qwe.com',
               status: 'in_progress', user_id: user.id
             )
  video = Video.first
